...
const enUS = {
  ...
  "settings.notifications.mentions": "Needs attention",
  "settings.notifications.all": "All AI activity",
  ...
  "terminal.quickKeys.collapse": "Collapse terminal keys",
  "terminal.quickKeys.navigation": "Navigation keys",
  "terminal.quickKeys.ctrl": "Ctrl combinations",
  "terminal.quickKeys.function": "Function keys",
  "terminal.quickKeys.symbols": "Symbols",
  "terminal.quickKeys.arrowUp": "Arrow up",
  "terminal.quickKeys.arrowDown": "Arrow down",
  "terminal.quickKeys.arrowLeft": "Arrow left",
  "terminal.quickKeys.arrowRight": "Arrow right",
  ...
  "terminal.openProgress.aria": "Session opening progress",
  "terminal.openProgress.openingAria": "Opening progress for {name}",
  "terminal.openProgress.opening": "Opening terminal",
  "terminal.openProgress.ready": "Terminal ready",
  "terminal.openProgress.failed": "Open failed",
  "terminal.openProgress.next": "Next",
  "terminal.openProgress.available": "Terminal available",
  "terminal.openProgress.retry": "Retry connection",
  "terminal.openProgress.step.selected": "Session selected",
  "terminal.openProgress.step.connecting": "Connect terminal channel",
  "terminal.openProgress.step.attaching": "Attach session",
  "terminal.openProgress.step.initializing": "Initialize terminal",
  "terminal.openProgress.step.syncing": "Sync terminal content",
...
const zhCN: Record<TranslationKey, string> = {
  ...
  "settings.notifications.mentions": "需要处理",
  "settings.notifications.all": "全部 AI 状态",
  ...
  "terminal.quickKeys.collapse": "收起终端快捷键",
  "terminal.quickKeys.navigation": "导航键",
  "terminal.quickKeys.ctrl": "Ctrl 组合键",
  "terminal.quickKeys.function": "功能键",
  "terminal.quickKeys.symbols": "符号",
  "terminal.quickKeys.arrowUp": "向上方向键",
  "terminal.quickKeys.arrowDown": "向下方向键",
  "terminal.quickKeys.arrowLeft": "向左方向键",
  "terminal.quickKeys.arrowRight": "向右方向键",
  ...
  "terminal.paste": "粘贴",
  "terminal.openProgress.aria": "会话打开进度",
  "terminal.openProgress.openingAria": "{name} 的打开进度",
  "terminal.openProgress.opening": "正在打开终端",
  "terminal.openProgress.ready": "终端已就绪",
  "terminal.openProgress.failed": "打开失败",
  "terminal.openProgress.next": "下一步",
  "terminal.openProgress.available": "终端可用",
  "terminal.openProgress.retry": "重试连接",
  "terminal.openProgress.step.selected": "已选择会话",
  "terminal.openProgress.step.connecting": "建立终端通道",
  "terminal.openProgress.step.attaching": "接入会话",
  "terminal.openProgress.step.initializing": "初始化终端",
  "terminal.openProgress.step.syncing": "同步终端内容",
