...
! grep -Eq '^[[:space:]]+images:' "${ROOT_DIR}/.github/workflows/release.yml"
! grep -Fq 'packages: write' "${ROOT_DIR}/.github/workflows/release.yml"
! grep -Eiq 'docker|podman|buildah|ghcr\.io' "${ROOT_DIR}/.github/workflows/release.yml"
